...
//注册处理界面 regcheck.php
 ...
 { 
    ...
    $sql1_insert = "insert into `paxrec` (`paxrec_id`,`dept_add`,`dept_city`,`dept_prov`,`dest_add`,`dest_city`,`dest_prov`,`driver_pref`,`wechat`,`phone`,`status`,`heat`,`pub_time`,`user_id`,`pax_num`,`descpt`) 
        values('" . $paxrec_id . "','" . $dept_add . "','" . $dept_city ."','" . $dept_prov . "','" . $dest_add . "','" . $dest_city . "','" . $dest_prov . "','" . $driver_pref . "','" . $wechat . "','" . $phone . "','" . $status . "','" . $heat . "','" . $pub_time . "','" . $user_id . "','" . $pax_num . "','" . $descpt . "')"; 
